...
# Form implementation generated from reading ui file 'spikefinding-vis.ui'
#
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.verticalLayout_TL = QtWidgets.QVBoxLayout()
        self.verticalLayout_TL.setObjectName("verticalLayout_TL")
        self.plot1 = PlotWidget(self.centralwidget)
        self.plot1.setObjectName("plot1")
        self.verticalLayout_TL.addWidget(self.plot1)
        self.plot2 = PlotWidget(self.centralwidget)
        self.plot2.setObjectName("plot2")
        self.verticalLayout_TL.addWidget(self.plot2)
        self.plot3 = PlotWidget(self.centralwidget)
        self.plot3.setObjectName("plot3")
        self.verticalLayout_TL.addWidget(self.plot3)
        self.plot4 = PlotWidget(self.centralwidget)
        self.plot4.setObjectName("plot4")
        self.verticalLayout_TL.addWidget(self.plot4)
        self.horizontalLayout_top.addLayout(self.verticalLayout_TL)
        self.verticalLayout_TR = QtWidgets.QVBoxLayout()
        self.verticalLayout_TR.setObjectName("verticalLayout_TR")
        self.plot5 = PlotWidget(self.centralwidget)
        self.plot5.setObjectName("plot5")
        self.verticalLayout_TR.addWidget(self.plot5)
        self.plot6 = PlotWidget(self.centralwidget)
        self.plot6.setObjectName("plot6")
        self.verticalLayout_TR.addWidget(self.plot6)
        self.plot7 = PlotWidget(self.centralwidget)
        self.plot7.setObjectName("plot7")
        self.verticalLayout_TR.addWidget(self.plot7)
        self.plot8 = PlotWidget(self.centralwidget)
        self.plot8.setObjectName("plot8")
        self.verticalLayout_TR.addWidget(self.plot8)
        self.horizontalLayout_top.addLayout(self.verticalLayout_TR)
        ...
        self.verticalLayout_BL = QtWidgets.QVBoxLayout()
        self.verticalLayout_BL.setObjectName("verticalLayout_BL")
        self.plot9 = PlotWidget(self.centralwidget)
        self.plot9.setObjectName("plot9")
        self.verticalLayout_BL.addWidget(self.plot9)
        self.plot10 = PlotWidget(self.centralwidget)
        self.plot10.setObjectName("plot10")
        self.verticalLayout_BL.addWidget(self.plot10)
        self.plot11 = PlotWidget(self.centralwidget)
        self.plot11.setObjectName("plot11")
        self.verticalLayout_BL.addWidget(self.plot11)
        self.plot12 = PlotWidget(self.centralwidget)
        self.plot12.setObjectName("plot12")
        self.verticalLayout_BL.addWidget(self.plot12)
        self.horizontalLayout_bottom.addLayout(self.verticalLayout_BL)
        self.verticalLayout_BR = QtWidgets.QVBoxLayout()
        self.verticalLayout_BR.setObjectName("verticalLayout_BR")
        self.plot13 = PlotWidget(self.centralwidget)
        self.plot13.setObjectName("plot13")
        self.verticalLayout_BR.addWidget(self.plot13)
        self.plot14 = PlotWidget(self.centralwidget)
        self.plot14.setObjectName("plot14")
        self.verticalLayout_BR.addWidget(self.plot14)
        self.plot15 = PlotWidget(self.centralwidget)
        self.plot15.setObjectName("plot15")
        self.verticalLayout_BR.addWidget(self.plot15)
        self.plot16 = PlotWidget(self.centralwidget)
        self.plot16.setObjectName("plot16")
        self.verticalLayout_BR.addWidget(self.plot16)
        self.horizontalLayout_bottom.addLayout(self.verticalLayout_BR)
