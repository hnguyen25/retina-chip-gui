...
# Form implementation generated from reading ui file 'default-vis.ui'
#
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.channelTrace1.setObjectName("traceplot_1")
        self.traceplot_verticalLayout.addWidget(self.channelTrace1)
        self.channelTrace2 = PlotWidget(self.centralwidget)
        self.channelTrace2.setObjectName("traceplot_2")
        self.traceplot_verticalLayout.addWidget(self.channelTrace2)
        self.channelTrace3 = PlotWidget(self.centralwidget)
        self.channelTrace3.setObjectName("traceplot_3")
        self.traceplot_verticalLayout.addWidget(self.channelTrace3)
        self.channelTrace4 = PlotWidget(self.centralwidget)
        self.channelTrace4.setObjectName("traceplot_4")
        self.traceplot_verticalLayout.addWidget(self.channelTrace4)
