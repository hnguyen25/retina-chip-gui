...
class Ui_Startup(object):
    def setupUi(self, Startup):
        ...
        self.gridLayout.addWidget(self.LabelSpikeThreshold, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.DialogButtonBox, 10, 0, 1, 3)
        self.VisualizationStyleLabel = QtWidgets.QLabel(Startup)
        self.VisualizationStyleLabel.setObjectName("VisualizationStyleLabel")
        self.gridLayout.addWidget(self.VisualizationStyleLabel, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.chooseSpikeThreshold, 8, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(Startup)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 5, 0, 1, 1)
        self.DataFileDirectory = QtWidgets.QLabel(Startup)
        self.DataFileDirectory.setObjectName("DataFileDirectory")
        self.gridLayout.addWidget(self.DataFileDirectory, 2, 0, 1, 1)
        self.SpikeDetectionMethodLabel = QtWidgets.QLabel(Startup)
        self.SpikeDetectionMethodLabel.setObjectName("SpikeDetectionMethodLabel")
        self.gridLayout.addWidget(self.SpikeDetectionMethodLabel, 7, 0, 1, 1)
        self.chooseSpikeDetectionMethod = QtWidgets.QComboBox(Startup)
        self.chooseSpikeDetectionMethod.setObjectName("chooseSpikeDetectionMethod")
        self.chooseSpikeDetectionMethod.addItem("")
        self.chooseSpikeDetectionMethod.addItem("")
        self.gridLayout.addWidget(self.chooseSpikeDetectionMethod, 7, 1, 1, 1)
        ...
        self.VisualizationStyleLabel.setBuddy(self.chooseVisStyle)
        self.label_4.setBuddy(self.chooseNumChannels)
        self.DataFileDirectory.setBuddy(self.chooseFilePath)
    ...
    def retranslateUi(self, Startup):
        ...
        self.VisualizationStyleLabel.setText(_translate("Startup", "Visualization style"))
        ...
        self.DataFileDirectory.setText(_translate("Startup", "Data file directory"))
        self.SpikeDetectionMethodLabel.setText(_translate("Startup", "Spike detection method"))
        self.chooseSpikeDetectionMethod.setItemText(0, _translate("Startup", "Thresholding (choose threshold below)"))
        self.chooseSpikeDetectionMethod.setItemText(1, _translate("Startup", "Gaussian Mixture Model "))
