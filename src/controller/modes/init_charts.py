...
def setup_layout(app, layout: str, CURRENT_THEME: str, themes: dict, NUM_CHANNELS_PER_BUFFER: int):
    ...
    elif layout == "Compression":
        from src.controller.modes.mode_compression import setup_compression
        setup_compression(app, CURRENT_THEME, themes, NUM_CHANNELS_PER_BUFFER)
